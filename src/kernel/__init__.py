...
* :mod:`~kernel.contracts` — what a plugin is (manifest + build)
* :mod:`~kernel.registry` — handles, kinds, capability index
* :mod:`~kernel.loader` — discovery of bundled and installed plugins
* :mod:`~kernel.bus` — the topic bus plugins talk over
* :mod:`~kernel.context` — what a plugin is handed when built
* :mod:`~kernel.kernel` — the composition root
"""
